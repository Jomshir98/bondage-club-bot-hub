...
fs.mkdirSync("./data/logs/gameroom1", { recursive: true });
AddFileOutput(`./data/logs/gameroom1/${logPrefix}_debug.log`, false, LogLevel.DEBUG);
AddFileOutput(`./data/logs/gameroom1/${logPrefix}_error.log`, true, LogLevel.ALERT);
