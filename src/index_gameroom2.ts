...
fsPromises
	.mkdir("./data/logs/gameroom2", { recursive: true })
	.then(() => fsPromises.open(`./data/logs/gameroom2/${logPrefix}_debug.log`, "w"))
	.then(log => logger.addFileOutput(LogLevel.DEBUG, log))
	.then(() => fsPromises.open(`./data/logs/gameroom2/${logPrefix}_error.log`, "as"))
