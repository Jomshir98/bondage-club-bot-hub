...
fs.mkdirSync("./data/logs/gameroom2", { recursive: true });
AddFileOutput(`./data/logs/gameroom2/${logPrefix}_debug.log`, false, LogLevel.DEBUG);
AddFileOutput(`./data/logs/gameroom2/${logPrefix}_error.log`, true, LogLevel.ALERT);
